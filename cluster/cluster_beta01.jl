...
#SBATCH --job-name=weighted_syk_1R2_beta01
...
@sync @distributed for i in 1:4
    remotecall_fetch(generate_1R2_weight_data, i, ws, L, β, qs[i]; init_lerp = 0.01, lerp_divisor = 2, tol=1e-5, max_iters=1000)
end
